    ...
    <div class="text-center">
      ...
      <div class="icons-wrapper">
        <?php if ( !empty( $twitter_icon ) ): ?>
          <a href="https://twitter.com/<?php echo $twitter_icon; ?>" target="_blank"><span class="sunset-icon-sisdebar sunset-icon sunset-twitter"></span></a>
        <?php endif; ?>
        <?php if ( !empty( $facebook_icon ) ): ?>
          <a href="https://facebook.com/<?php echo $facebook_icon; ?>" target="_blank"><span class="sunset-icon-sisdebar sunset-icon sunset-googleplus"></span></a>
        <?php endif; ?>
        <?php if ( !empty( $gplus_icon ) ): ?>
          <a href="https://plus.google.com/u/0/+<?php echo $gplus_icon; ?>" target="_blank"><span class="sunset-icon-sisdebar sunset-icon sunset-facebook"></span></a>
        <?php endif; ?>
      </div>
    </div>
...
class Sunset_Popular_Posts_Widget extends WP_Widget {
    ...
    public function update( $new_instance, $old_instance ) {
      ...
      $instance['tot'] = !empty( $new_instance['tot'] ) ? absint( $new_instance['tot'] ) : '';
