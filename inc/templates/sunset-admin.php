  ...
  <div class="sunset-sidebar">
    ...
    <div class="icons-wrapper">
      <?php if ( !empty( $twitter_icon ) ): ?>
        <span class="sunset-icon-sisdebar dashicons-before dashicons-twitter"></span>
      <?php endif; ?>
      <?php if ( !empty( $facebook_icon ) ): ?>
        <span class="sunset-icon-sisdebar sunset-icon-sisdebar--gplus dashicons-before dashicons-googleplus"></span>
      <?php endif; ?>
      <?php if ( !empty( $gplus_icon ) ): ?>
        <span class="sunset-icon-sisdebar dashicons-before dashicons-facebook-alt"></span>
      <?php endif; ?>
    </div>
  </div>
</div>
